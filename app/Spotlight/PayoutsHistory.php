...
class PayoutsHistory extends SpotlightCommand
{
    /**
     ...
     */
    protected string $description = 'Redirect to user payouts history page';

    /**
     * You can define any number of additional search terms (also known as synonyms)
     * to be used when searching for this command.
     */
    protected array $synonyms = ['payouts','payouts history', 'payout', 'payout history'];
    ...
    {
        $spotlight->redirect(route('tutor.payouts'));
    }
    /**
