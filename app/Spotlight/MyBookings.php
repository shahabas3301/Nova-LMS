...
class MyBookings extends SpotlightCommand
{
    /**
     ...
     */
    protected string $description = 'Redirect to user my bookings page';

    /**
     * You can define any number of additional search terms (also known as synonyms)
     * to be used when searching for this command.
     */
    protected array $synonyms = ['my bookings','bookings', 'sessions','booking', 'my sessions'];
    ...
    {
        $spotlight->redirect(route('student.bookings'));
    }
    /**
