...
jQuery(window).on('load', function () {
    ...
    jQuery(document).on('change', '.uc-background_option', function (e) {
        e.preventDefault();
    ...
    jQuery(document).on('click', '.uc-element-wildcard', function (e) {
        ...
        let button = actionButtons(actionsArray);
...
function actionButtons(actions) {
    let html = `<div class="uc-wildcard_option uc-active">`;
...
function openModal(dt, desc = '', icon = 'delete') {
    ...
    let warningIcon = `<svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" fill="none">
