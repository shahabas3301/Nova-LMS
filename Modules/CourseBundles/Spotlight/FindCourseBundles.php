...
namespace Modules\CourseBundles\Spotlight;
...
class FindCourseBundles extends SpotlightCommand
{
    /**
     * This is the name of the command that will be shown in the Spotlight component.
     */
    protected string $name = 'Find Course Bundles';

    /**
     * This is the description of your command which will be shown besides the command name.
     */
    protected string $description = 'Redirect to user course bundles search page';

    /**
     * You can define any number of additional search terms (also known as synonyms)
     * to be used when searching for this command.
     */
    protected array $synonyms = ['course bundles', 'course bundle', 'search bundles', 'bundle', 'bundles'];
    ...
    {
        $spotlight->redirect(route('coursebundles.course-bundles'));
    }
    /**
