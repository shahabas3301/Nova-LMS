...
class CourseBundlesServiceProvider extends ServiceProvider
{
    use PathNamespace;

    protected string $name = 'CourseBundles';

    protected string $nameLower = 'coursebundles';
    ...
    public function boot(): void
    {
        ...
        Livewire::component('coursebundles::create-course-bundle',                               CreateBundle::class);
        Livewire::component('coursebundles::bundle-details',                                     BundleDetails::class);
        Livewire::component('coursebundles::search-courses-bundles',                             SearchCoursesBundles::class);
        Livewire::component('coursebundles::manage-courses-bundles',                             BundleListing::class);
        Livewire::component('coursebundles::course-bundles-listing',                             CourseBundleListing::class);
    }
