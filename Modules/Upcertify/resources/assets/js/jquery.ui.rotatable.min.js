    ...
    return (
        t.widget('ui.rotatable', t.ui.mouse, {
            ...
            rotationCenterOffset: function (t) {
                ...
                null !== t.top &&
                    (this.options.rotationCenterOffset.top = t.top),
                    null !== t.left &&
                        (this.options.rotationCenterOffset.left = t.left);
            },
            rotateElement: function (t) {
                ...
                if (
                    ((this.elementCurrentAngle = e),
                    this._propagate('rotate', t),
                    !1 === this._propagate('rotate', t))
                )
                    return (this.elementCurrentAngle = n), !1;
                var s = this.ui();
                return !1 === this._trigger('rotate', t, s)
                    ? ((this.elementCurrentAngle = n), !1)
                    : (s.angle.current !== e &&
                          ((e = s.angle.current),
                          (this.elementCurrentAngle = e)),
                      this._performRotation(e),
            ...
            startRotate: function (e) {
                var n = this.getElementCenter(),
                    ...
                    i = e.pageY - n.y;
                return (
                    (this.mouseStartAngle = Math.atan2(i, s)),
                    (this.elementStartAngle = this.elementCurrentAngle),
                    (this.hasRotated = !1),
                    this._propagate('start', e),
                    t(document).bind('mousemove', this.listeners.rotateElement),
                    t(document).bind('mouseup', this.listeners.stopRotate),
                    !1
                );
            },
            ...
            wheelRotate: function (t) {
                if (
                    ...
                    t.preventDefault();
                    var e = this._angleInRadians(
                        Math.round(t.originalEvent.deltaY / 10)
                    );
                    (this.options.snap || t.shiftKey) &&
                        (e = this._calculateSnap(e)),
            ...
            _calculateSnap: function (t) {
                ...
                return (
                    (e = Math.round(e / this.options.step) * this.options.step),
                    this._angleInRadians(e)
                );
            },
            ...
            _create: function () {
                var e;
                this.options.handle
                    ? (e = this.options.handle)
                    : ((e = t(document.createElement('div'))).addClass(
                          'ui-rotatable-handle'
                      ),
                      (0 === this.options.handleOffset.top &&
                          0 === this.options.handleOffset.left) ||
                          (e.css('position', 'relative'),
                          e.css('top', this.options.handleOffset.top + 'px'),
                          e.css(
                              'left',
                              this.options.handleOffset.left + 'px'
                          ))),
                    (this.listeners = {
                    ...
                    e.bind('mousedown', this.listeners.startRotate),
                    e.closest(this.element).length || e.appendTo(this.element),
                    this.rotationCenterOffset(
                        this.options.rotationCenterOffset
                    ),
                    this.options.degrees
                        ? (this.elementCurrentAngle = this._angleInRadians(
                              this.options.degrees
                          ))
            ...
            _isRotationCenterSet: function () {
                return (
                    0 !== this.options.rotationCenterOffset.top ||
                    0 !== this.options.rotationCenterOffset.left
                );
            },
            _performRotation: function (t) {
                this._isRotationCenterSet() &&
                    (this.element.css(
                        'transform-origin',
                ...
                this.element.css('transform', e),
                    this.element.css('-moz-transform', e),
                    this.element.css('-webkit-transform', e),
