...
namespace Modules\Subscriptions\Spotlight;
...
class Subscriptions extends SpotlightCommand
{
    /**
     ...
     */
    protected string $description = 'Redirect to user subscriptions page';

    /**
     * You can define any number of additional search terms (also known as synonyms)
     * to be used when searching for this command.
     */
    protected array $synonyms = ['subscriptions', 'subscription', 'my subscriptions', 'my subscription'];
    ...
    {
        $spotlight->redirect(url(auth()->user()->role.'-subscriptions'));
    }
    /**
