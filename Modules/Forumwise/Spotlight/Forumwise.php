...
namespace Modules\Forumwise\Spotlight;
...
class Forumwise extends SpotlightCommand
{
    /**
     ...
     */
    protected string $description = 'Redirect to user community or forums page';

    /**
     * You can define any number of additional search terms (also known as synonyms)
     * to be used when searching for this command.
     */
    protected array $synonyms = ['community', 'forumwise', 'forum', 'forums'];
    ...
    {
        $spotlight->redirect(route('forums'));
    }
    /**
