...
namespace Modules\Assignments\Spotlight;
...
class MyAssignments extends SpotlightCommand
{
    /**
     ...
     */
    protected string $description = 'Redirect to user assignments page';

    /**
     * You can define any number of additional search terms (also known as synonyms)
     * to be used when searching for this command.
     */
    protected array $synonyms = ['assignments', 'assignment', 'my assignments', 'my assignment'];
    ...
    {
        $spotlight->redirect(route('assignments.student.student-assignments'));
    }
    /**
    ...
    {
        if( Module::has('assignments') && Module::isEnabled('assignments')) {
