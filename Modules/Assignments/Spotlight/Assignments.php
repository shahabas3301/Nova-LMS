...
class Assignments extends SpotlightCommand
{
    /**
     ...
     */
    protected array $synonyms = ['assignments', 'assignment', 'manage assignments'];
    ...
    {
        $spotlight->redirect(route('assignments.tutor.assignments-list'));
    }
    /**
