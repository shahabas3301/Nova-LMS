...
namespace Modules\Starup\Providers;
...
class StarupServiceProvider extends ServiceProvider
{
    use PathNamespace;

    protected string $name = 'Starup';

    protected string $nameLower = 'starup';
    ...
    public function boot(): void
    {
        ...
        Livewire::component('starup::badge-list', BadgeList::class);
    }
