...
$__html = app('livewire')->mount($__name, $__params, 'lw-1859650386-0', $__slots ?? [], get_defined_vars());
                ...
                <?php if($userRole == 'student'): ?>
                    <li>
                        <a href="<?php echo e(route('student.profile.personal-details')); ?>">
                            ...
                            <?php if(setting('_sidebar_menu.student_profile_settings_menu')): ?>
                    ...
                    <li>
                        <a href="<?php echo e(route('student.bookings')); ?>">
                            ...
                            <?php if(setting('_sidebar_menu.my_bookings_menu')): ?>
                    ...
                    <li>
                        <a href="<?php echo e(route('student.billing-detail')); ?>">
                            ...
                            <?php if(setting('_sidebar_menu.billing_detail_menu')): ?>
                    ...
                    <li>
                        <a href="<?php echo e(route('student.favourites')); ?>">
                            ...
                            <?php if(setting('_sidebar_menu.favourites_menu')): ?>
                    ...
                    <li>
                        <a href="<?php echo e(route('find-tutors')); ?>" >
                            ...
                            <?php if(setting('_sidebar_menu.find_tutors_menu')): ?>
                ...
                <?php elseif($userRole == 'tutor'): ?>
                    <li>
                        <a href="<?php echo e(route('tutor.dashboard')); ?>">
                            ...
                            <?php if(setting('_sidebar_menu.dashboard_menu')): ?>
                    ...
                    <li>
                        ...
                        <?php if(setting('_sidebar_menu.profile_settings_menu')): ?>
                    ...
                    <li>
                        <a href="<?php echo e(route('tutor.bookings.subjects')); ?>">
                            <i class="am-icon-calender-day"></i>
                            <?php if(setting('_sidebar_menu.manage_bookings_menu')): ?>
                    ...
                    <li>
                        <a href="<?php echo e(route('tutor.invoices')); ?>">
                            ...
                            <?php if(setting('_sidebar_menu.invoices_menu')): ?>
                ...
                <?php if($userRole == 'tutor' || $userRole == 'student'): ?>
                    <li>
                        <a href="<?php echo e(route('laraguppy.messenger')); ?>">
                            <i class="am-icon-chat-03"></i>
                            <?php if(setting('_sidebar_menu.student_inbox_menu')): ?>
...
</script><?php /**PATH /home/nidheesh/workspace/Nova-LMS/resources/views/components/frontend/user-menu.blade.php ENDPATH**/ ?>